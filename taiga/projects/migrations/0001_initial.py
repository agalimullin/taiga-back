    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_epics_activated', models.BooleanField(default=False, verbose_name='active epics panel')),
                ...
                ('videoconferences', models.CharField(blank=True, choices=[('appear-in', 'AppearIn'), ('jitsi', 'Jitsi'), ('custom', 'Custom'), ('talky', 'Talky')], max_length=250, null=True, verbose_name='videoconference system')),
                ...
                ('is_looking_for_people', models.BooleanField(default=False, verbose_name='is looking for people')),
