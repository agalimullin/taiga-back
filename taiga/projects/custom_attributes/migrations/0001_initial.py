    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('text', 'Text'), ('multiline', 'Multi-Line Text'), ('richtext', 'Rich text'), ('date', 'Date'), ('url', 'Url')], default='text', max_length=16, verbose_name='type')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('attributes_values', taiga.base.db.models.fields.json.JSONField(default={}, encoder=django.core.serializers.json.DjangoJSONEncoder, verbose_name='values')),
            ],
            options={
